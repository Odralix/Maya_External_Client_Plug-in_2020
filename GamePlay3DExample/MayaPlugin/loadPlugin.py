...
# load plugin
s.send(b'loadPlugin("D:/School/Ar 3 TechArt/Konstruktion av spelteknikverktyg UD1447/Maya communication Plug-in/GamePlay3DExample/MayaPlugin/x64/Debug/MayaAPI.mll")\n')
